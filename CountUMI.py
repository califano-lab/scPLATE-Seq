...
for k in umi_dict.keys():
    ...
    if int(hammingThreshold) == 0:
        umi = len(seq)
    #number of transcripts when not doing hamming distance correction, this will speed-up the process
    else:
    ...
    #number of transcripts, number of disconnected subgraphs in umi sequence space when doing hamming distance correction
